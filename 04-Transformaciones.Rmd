...
```{r EducBC2Fig, echo=TRUE, fig.height = 3, fig.width = 7,fig.align = "center",fig.cap = "Datos de educación. Graficos de los residuos para el modelo transformado.",warning=FALSE,message = FALSE}
