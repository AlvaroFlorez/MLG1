...
```{r Un11res, echo=T, fig.height = 3, fig.width = 4,fig.align = "center",fig.cap = "Datos de la ONU. Gráfico de los residuos estudentizados.",warning=FALSE,message = FALSE}
...
```{r Un11resPartial, echo=T, fig.height = 3, fig.width = 7,fig.align = "center",fig.cap = "Datos de la ONU. Gráfico de los residuos  parciales.",warning=FALSE,message = FALSE}
library(car)
...
```{r UNtrans2Fig, echo=TRUE, fig.height = 3, fig.width = 6,fig.align = "center",fig.cap = "Datos de la ONU. Gráficos de los residuos para el modelo transformado.",warning=FALSE,message = FALSE}
...
```{r educLambda, echo=TRUE, fig.height = 3.6, fig.width = 3.5,fig.align = "center",fig.cap = "\\label{fig:EducBC} Datos de educación. Perfiles de verosimilitud para $\\lambda$.",warning=FALSE,message = FALSE}
...
```{r EducBC2Fig, echo=TRUE, fig.height = 3, fig.width = 7,fig.align = "center",fig.cap = "\\label{Datos de educación. Graficos de los residuos para el modelo transformado.",warning=FALSE,message = FALSE}
...
---
nocite: @montgomery_introduction_2012, @fox_applied_2016
---
