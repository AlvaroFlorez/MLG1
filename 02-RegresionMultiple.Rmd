...
\]
donde:
- $SS_{R} = \sum_{i=1}^{n}(\haty_{i}-\bar{y})^{2} = (\bH\by - \frac{1}{n}\bONE\bONE'\by)'(\bH\by - \frac{1}{n}\bONE\bONE'\by)=\by'(\bH\by - \frac{1}{n}\bONE\bONE')\by$,
...
\[
SS_{R}(\bbeta) = \by'(\bH\by - \frac{1}{n}\bONE\bONE')\by.
\]
...
- Suma de cuadrados del modelo: 
\[
SS_{R}(\bbeta_{1}) = \by'(\bH\by - \frac{1}{n}\bONE\bONE')\by.
\]
