...
```{r gendataFigure,echo=FALSE, fig.height = 4.5, fig.width = 6,fig.align = "center",fig.cap = "Proceso generador datos del modelo lineal simple."}
...
```{r anovafig, echo=FALSE, fig.height = 4.5, fig.width =6,fig.align = "center",fig.cap = "Representación gráfica de la partición \\@ref(eq:decomposion)."}
plot(x,y,xlab='covariable = X',ylab = 'variable respuesta = Y')
abline(m,col=1)
