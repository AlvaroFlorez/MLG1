...
text(3-0.1,y[3]+3,expression(y[3]-hat(y)[3]),pos=2,cex=0.8)
brackets(3, predict(m)[3], 3, mean(y),h=0.2,ticks=0.5,type=1,xpd=F)
text(3-0.1,predict(m)[3]+2.5,expression(hat(y)[3]-bar(y)),pos=2,cex=0.8)
brackets(1.7, y[3], 1.7, mean(y),h=0.2,ticks=0.5,type=1,xpd=F)
text(1.7,predict(m)[3],expression(y[3]-bar(y)),pos=2,cex=0.8)
```
